...
[cite_start]This repository contains the implementation and verification of a 2-to-1 Multiplexer (MUX) using Verilog Dataflow modeling[cite: 1].
...
* [cite_start]**Inputs:** `a`, `b`, `sel` [cite: 1]
